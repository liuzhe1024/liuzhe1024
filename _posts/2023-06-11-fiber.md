- #  目录
  ...
  ![img](/assets/images/posts/react/fiber1.webp)

  [Stack Example](https://claudiopro.github.io/react-fiber-vs-stack-demo/stack.html)

  ![img](/assets/images/posts/react/fiber2.webp)
  ...
  ![img](/assets/images/posts/react/fiber3.gif)
  ...
  ![img](/assets/images/posts/react/fiber4.webp)

  `react fiber`，灵活让出控制权保证渲染与浏览器响应

  ![img](/assets/images/posts/react/fiber5.webp)
  ...
  ![img](/assets/images/posts/react/fiber6.png)
  ...
  ![img](/assets/images/posts/react/fiber0.png)
  ...
  ![img](/assets/images/posts/react/fiber7.png)
  ...
  **提交阶段**：将协调阶段计算出来的变更一次性提交，此阶段同步进行且不可中断（优先保证渲染）。
  ...
  ![img](/assets/images/posts/react/fiber8.png)
  ...
  在 `createChild` 中核心就两点，调用 `createFiberFromElement` 方法，顾名思义，根据 `element` 节点（虚拟 element 节点）来创建 `fiber` 节点。其次，在生成 `fiber` 后为通过 `return` 为其设置父节点。
  ...
  ![img](/assets/images/posts/react/fiber9.png)
  ...
  ![img](/assets/images/posts/react/fiber10.png)
  ...
  ![img](/assets/images/posts/react/fiber11.png)
  ...
  ![img](/assets/images/posts/react/fiber12.png)
  ...
  ![img](/assets/images/posts/react/fiber13.png)
